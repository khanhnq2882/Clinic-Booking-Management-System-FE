...
export class UpdateDoctorProfileComponent {
  ...
  workSchedulesDTO : WorkScheduleDTO[] = [
    new WorkScheduleDTO('08:00', '09:00'),
    new WorkScheduleDTO('09:00', '10:00'),
    new WorkScheduleDTO('10:00', '11:00'),
    new WorkScheduleDTO('11:00', '12:00'),
    new WorkScheduleDTO('13:00', '14:00'),
    new WorkScheduleDTO('14:00', '15:00'),
    new WorkScheduleDTO('15:00', '16:00'),
    new WorkScheduleDTO('16:00', '17:00'),
    new WorkScheduleDTO('17:00', '18:00'),
    new WorkScheduleDTO('18:00', '19:00'),
    new WorkScheduleDTO('19:00', '20:00'),
  ];
